...
Under TEFCA, QHINs will provide a single point of connection for PHAs to reach out to the nationwide network of responders. QHINs help PHAs use FHIR to connect to a network of networks, Record Locator Services, and a Directory of Requestors/Responders, following a federally supported set of standards. Record Locator Services need to be jurisdiction sensitive to access minimum necessary data as authorized so PHAs do not inadvertently pull data from other jurisdictions for the patient.
