...
* process[0].step[0].operation[0].initiator = "Public Health Newborn Screening Program (EHDI/CCHD)"
* process[0].step[0].operation[0].receiver = "Healthcare Organization Conducing Bedside Newborn Screening (EHDI/CCHD)"
...
* process[0].step[1].operation[0].initiator = "Healthcare Organization Conducing Bedside Newborn Screening (EHDI/CCHD)"
* process[0].step[1].operation[0].receiver = "Public Health Newborn Screening Program (EHDI/CCHD)"
